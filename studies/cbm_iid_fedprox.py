"""CBM naval-propulsion regression — IID sharding, FedProx aggregation (μ=0.1).

    bash scripts/start.sh studies.cbm_iid_fedprox:make_spec            # simulation
    bash scripts/run_on_testbed.sh studies.cbm_iid_fedprox:make_spec   # real Pis
"""
